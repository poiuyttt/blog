namespace BlogApi.Services
{
    ...
    public class FileService : IFileService
    {
        ...
        public FileService(ILogger<FileService> logger)
        {
            ...
            _uploadRoot = Path.Combine(Directory.GetCurrentDirectory(), "upload");
        ...
        public async Task<string> SaveFileAsync(IFormFile file)
        {
            ...
            string relativePath = Path.Combine("uploads", dateFolder, uniqueFileName).Replace("\\", "/");
        ...
        /// 读取文件内容（用于下载）
        /// </summary>
        public async Task<byte[]> GetFileByteAsync(string relativePath)
        {
